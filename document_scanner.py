...
def auto_rotate_document(img: Image.Image) -> Image.Image:
    """
    Hujjatdagi matn yo'nalishini aniqlashga harakat qiladi.
    Tesseract mavjud bo'lsa OSD ishlatadi, bo'lmasa asl rasmni qaytaradi.
    """
    try:
        import pytesseract
        ...
        # Tesseract yo'q yoki xato - asl rasmni qaytaramiz
        pass
    return img
